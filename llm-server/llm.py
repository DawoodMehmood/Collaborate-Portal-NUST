...
def modifyData(input_json, data):
    ...
    #------------------------------Search By Name----------------------------------------
        ...
        if input_json["thing"] == 'Publications':
            columns_to_delete = ["activity_exception_decoration", "author_ids_autohr_sequence_compute ",  "author_ids_co_author_student_id", "author_ids_combined_faculty_staff_id", "author_ids_country", "author_ids_id", "author_ids_institute_other_than_nust_temp", "author_ids_is_corresponding_author", "author_ids_is_sole_author", "author_ids_journal_paper_id", "author_ids_nust_auth_faculty_staff_id", "author_ids_school", "author_ids_student_school", "category", "citation_count_scopus_opd_on", "citation_count_wos", "fin_date_of_approval", "findet_ids_fin_date_of_approval", "findet_ids_fin_e_min_sheet_no", "findet_ids_fin_remarks", "findet_ids_fin_share_of_author", "findet_ids_id", "findet_ids_institute_id", "findet_ids_journal_publication_id", "findet_ids_pc_date_of_approval_pub_charg", "hec_jpi", "hec_medallion", "h_index", "id", "impact_factor_hjrs", "indexation", "int_h_index", "int_webofscience_scopus", "paid_open_ended", "pc_approval_date", "state_123", "title", "findet_ids"]
            column_rename_dict = {"g_r_count": "Serial number", "abstract": "Publication Abstract", "affiliation": "Affiliation - NUST/Other", "all_author_compute": "Publication Authors List", "author_ids_affiliation": "Affiliation - NUST/Local/Foreign", "author_ids_autohr_sequence":"Author Sequence", "author_ids_co_author_faculty_staff_id":"Author ID", "author_ids_country_disp_compute":"Author County Affiliation", "author_ids_designation":"Author NUST Designation", "author_ids_faculty_school":"Author NUST School", "author_ids_faculty_student_author_compute":"Author ID", "author_ids_institute":"Author Foreign Affiliation", "author_ids_journal_publication_id":"Publication Title", "author_ids_journal_publication_year_compute":"Publication year", "author_ids_name":"Author Names", "author_ids_school_disp_compute":"Author Affiliation", "citation_count_scopus":"Scopus Citations", "collaboration_type":"Collaboration Type", "country":"Publisher Country", "discipline":"Publication Discipline", "doi_info":"DOI", "findet_ids_autohr_sequence":"Author sequence", "findet_ids_currency_id":"Financial Award currency", "findet_ids_designation":"Author designation", "findet_ids_fin_faculy_staff_id":"Financial award recipient ID", "findet_ids_fin_total_finance_award":"Financial Award Amount", "findet_ids_pc_applicant_name":"publication charges applicant name", "findet_ids_pc_e_min_sheet_no":"Publication Charges minute sheet number", "findet_ids_pc_faculy_staff_id":"Publication charges applicant ID", "findet_ids_pc_name_of_currancy":"Publication Charges Currency", "findet_ids_pc_share_of_author":"Publication charges author share", "findet_ids_pc_total_pub_charges":"Publication Charges Amount", "fin_e_min_sheet_no":"Financial Award eminute sheet", "hec_hec_category":"HEC Category", "hec_rank_pos_of_journal":"HEC Rank of Journal", "hec_total_journals_in_category":"HEC Total Journal in Category", "impact_factor":"Impact factor", "int_quartiles":"Web of Science Quartiles", "int_rank_pos_of_journal":"Web of Science Rank of Journal", "int_total_journals_in_category":"Web of Science Total Journals", "journal_info":"Journal Info", "journal_title":"Journal Name", "online_publication_date":"Online Publication Date", "pc_e_min_sheet_no":"Publication charges minute sheet number", "print_published":"Print/Online Publication", "publication_date":"Print Publication Date", "publication_year_compute":"Publication Year", "publisher_address":"Publisher address", "publisher_name":"Publisher Name", "school":"School Affiliation", "sdgs":"SDGs", "site_score":"Scopus Cite Score", "type":"Publication Type", "website_link":"Website link", "sdgs_id":"SDG Number", "sdgs_name":"SDG Name"}
