...
def getAnswer(query, df):
    ...
    return davinci_agent.run("I will pass a question to you alongwith data. Answer the question following the special instructions wherever necessary and always use unique() function. Important Special instructions: 1- Only for questions asking for sum or average, always remove the duplicate entries using the column subset 'Serial number'. 2- For questions where you need to search for some string, always consider it case insensitive and use str.contains() function.  Question: " + query + " , return unique and complete answer.")
